...
const DetailList = (props) => {
  return (
    <div>
      ...
      <li>
        <h6>Property rented with you :</h6>
        <p>F-244, Phase 8B, Industrial Area</p>
      </li>
      <li>
      ...
      <li>
        <h6>Tenancy Start Date :</h6>
        <p>01/04/2020</p>
      </li>
      <li>
        <h6>Tenancy End Date :</h6>
        <p>01/04/2021</p>
      </li>
      <li>
        <h6>Is the applicant free to move out?</h6>
        <p>Yes</p>
      </li>
      <li>
        <h6>Would you recommend them as tenants?</h6>
        <p>No</p>
      </li>
      <li>
        <h6>
      ...
      <li>
        ...
        <p className="d-flex align-items-center ms-lg-0">
          signature.png
          <span>
            <img src={viewIcon} alt="view-icon" className="view-icon ms-3" />
          </span>
...
const LandRef = (props) => {
  let arr = [props.item.appName, "John"]
  ...
  return (
    <>
      ...
      {/* {props.item.landRef === "Completed" ? <LandlordRefCnt item={props.item}/> : <RefIncomplete />} */}
      {props.item.landRef === "Completed" ?
        arr?.map((item, i) => { return <LandlordRefCnt className={item === actBtn ? "d-block" : "d-none"} item={item} key={i} /> }) :
        arr?.map((item, i) => { return <RefIncomplete className={item === actBtn ? "d-block" : "d-none"} item={item} key={i} /> })}
    </>
  );
};

export default LandRef;

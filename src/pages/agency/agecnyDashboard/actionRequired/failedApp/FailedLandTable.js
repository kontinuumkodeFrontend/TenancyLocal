    ...
    const options = {
        ...
        onCellClick: function (colData, cellMeta) {
            ...
            if (cellMeta.colIndex === 8) {
                cellMeta.event.stopPropagation(); //to stop the onRowClick fun from firing for col 8
            }
        },
    };
...
export default FailedLandTable;
